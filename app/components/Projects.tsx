      ...
      <div className="projectsSection">
        ...
        <div className="Map">
          ...
          <div className="projectTitle">
            ...
            <span>
              A Netflix clone, solely designed using Angular and Typescript. Its
              an exercise in frontend development, aiming to capture the look
              and feel of Netflixs user interface.
            </span>
            <div className="projectSkills">
